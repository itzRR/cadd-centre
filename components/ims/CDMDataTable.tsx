                            ...
                            {actions.filter(a => !a.show || a.show(row)).map((action, ai) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`p-1.5 rounded-lg transition-all whitespace-nowrap ${colors[action.variant || "default"]}`}
                                  title={action.label}
                                >
                                    ...
                                    {actions.filter(a => !a.show || a.show(row)).map((action, ai) => {
                                      ...
                                      return (
                                        <button
                                          ...
                                          className={`w-full flex items-center gap-2 px-3 py-2 text-sm font-medium transition-all whitespace-nowrap ${colors[action.variant || "default"]}`}
                                        >
